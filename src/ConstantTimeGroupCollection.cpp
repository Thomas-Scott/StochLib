...
int ConstantTimeGroupCollection::selectReaction(StochLib::RandomGenerator &randomGenerator) {
...
int ConstantTimeGroupCollection::selectGroupIndex(StochLib::RandomGenerator &randomGenerator) {
  int groupIndex=-1;
  double r=0;
  while (r==0) {
